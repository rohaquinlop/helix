...
impl MappableCommand {
    ...
    static_commands!(
        ...
        goto_definition_or_reference, "Goto definition, or references when already on definition",
        ...
        toggle_dim, "Toggle dimming of non-highlighted text",
        goto_next_reference, "Goto next reference in file",
        goto_prev_reference, "Goto previous reference in file",
